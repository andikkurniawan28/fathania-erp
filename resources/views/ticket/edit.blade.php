...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'edit_ticket')) }}
@endsection
                    ...
                    <div class="card-body">
                        <form action="{{ route('ticket.update', $ticket->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" id="user" name="assigned_to_id" width="100%" required>
                                        <option disabled>Select a {{ ucwords(str_replace('_', ' ', 'user')) }} :</option>
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ $ticket->assigned_to_id == $user->id ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="subject" name="subject" value="{{ old('subject', $ticket->subject) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="priority" name="priority" value="{{ old('priority', $ticket->priority) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="description">{{ old("description", $ticket->description) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="status" name="status" value="{{ old('status', $ticket->status) }}" required>
                                </div>
                            </div>
