                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="manage">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $tax_rate->id }}" data-name="{{ $tax_rate->name }}">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    const tax_rate_id = this.getAttribute('data-id');
                    const tax_rate_name = this.getAttribute('data-name');
                    Swal.fire({
                        title: 'Are you sure?',
                        ...
                        if (result.isConfirmed) {
                            ...
                            form.setAttribute('action',
                                `{{ route('tax_rate.destroy', ':id') }}`.replace(
                                    ':id', tax_rate_id));
                            ...
                            name.setAttribute('value', tax_rate_name);
